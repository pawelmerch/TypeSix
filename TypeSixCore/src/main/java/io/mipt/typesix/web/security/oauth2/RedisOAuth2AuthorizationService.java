...
/**
 * Taken from https://habr.com/ru/articles/748584/
 */
@Profile("!test")
@Component
public class RedisOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    private final static long TIME_TO_LIVE = 720000;
    ...
    public void save(OAuth2Authorization authorization) {
        ...
        this.authorizations.set(key, authorization, TIME_TO_LIVE, TimeUnit.MILLISECONDS);
    }
