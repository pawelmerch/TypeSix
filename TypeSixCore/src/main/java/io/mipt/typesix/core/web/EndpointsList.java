package io.mipt.typesix.core.web;

import io.mipt.typesix.core.web.swagger.Type6Endpoint;

import static io.mipt.typesix.core.web.swagger.Type6Endpoint.ENDPOINT_CATEGORY.*;
